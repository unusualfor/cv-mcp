...
- Escalated and structured Red Hat/OCP technical issues affecting XRAN/SR-04.x; evaluated RHEL for Edge, bootc, and MicroShift for DAS/Jazz deployments.
...
- Drove XRAN/SBMA architecture governance including SR-04.01/SR-05 SRS/PRD alignment and Red Hat OpenShift PoCs (XRAN on OCP, IPSec 6WIND router on OCP).
...
- Formalized XRAN load and performance testing for each major release (starting SR-04), expanding scope to include UEs per cell, CU-CP/CU-UP scalability, gNB-DUs per CU, and system topology limits. Established System Dimensioning Guidelines as a formal G3 milestone deliverable.
...
- Drove 6WIND renewal and alternatives analysis for SR-04 IPSec needs (Cisco VPP/fd.io, Rambus IPSec toolkit, strongSwan with DPDK fastpath).
- Contributed to O-Cloud technical strategy and NTIA NOFO 2 platform development for the federal market.
...
- Supported Wind River WRCP production deployment for SoftBank, resolving containerd/SR-IOV/Mellanox NIC issues; authored containerization platforms analysis comparing VMware Tanzu, Wind River WRCP, Red Hat OpenShift/OKD, and internal Kubernetes.
- Led Juniper/Vodafone Greece Security Gateway integration, debugging certificate trust chains, AutoVPN behavior, and strongSwan configuration alignment.
...
- Built deep Cisco NCS 540 PTP configuration expertise for G.8275.1 and G.8275.2 profiles, including Grandmaster and Boundary Clock use cases. Managed NCS 540 deployment across BTC, RTC, TIM TILab, and Vodafone-related environments.
