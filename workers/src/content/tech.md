...
- **Wind River WRCP** — evaluated and deployed for SoftBank 5G scenarios (2021–2022). Kernel roadmap analysis (CentOS 7 / Yocto / Debian), BPF vs Preempt-RT constraints, SR-IOV setup, containerd configuration, and production patching.
...
- **6WIND VSR / 6WINDGate** — high-performance IPSec acceleration achieving approximately 9.1 Gbps on 10 Gbps link (2021). Ongoing integration for SR-04 on RHEL/OCP/AMD EPYC/Mellanox platforms.
...
- **5G NR** — system architecture for gNB CU-CP, CU-UP, and DU components across multiple software releases (SR-02 through SR-05).
...
- **Wind River** — WRCP deployment and production support for SoftBank, kernel profile analysis, and containerization platform comparison (2021–2022).
...
- **Juniper** — IPsec/Security Gateway integration for Vodafone Greece Open RAN, debugging certificate trust chains and AutoVPN behavior (2021).
...
- **6WIND** — high-performance IPSec acceleration from initial contact (2020) through benchmarking (9.1 Gbps, 2021), Cell Site Router re-evaluation (2022), and ongoing SR-04 integration on RHEL/OCP/AMD EPYC (2024–2025).
...
- **TIM** — TILab O-RAN plugfest preparation, timing validation, Cisco NCS 540 deployment, and Fujitsu/Mavenir O-RU integration context (2020–2022).
- **SoftBank** — Wind River WRCP deployment, kernel profile analysis, and XRAN production support (2021–2022).
- **Vodafone** — Vodafone Greece Open RAN Security Gateway integration with Juniper (2021); Vodafone Italy coordination.
- **Verizon** — IOTA RFP context (2019).
